...
.links{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin:30px 0 0}
...
<p>過程中發現兩件會影響交易的事，都寫在後面，請您先過目。</p>
</div>
...
<div class="mark w">
<p><b>一、三筆土地不是同一個人的名字。</b></p>
<p>367 和 368 登記在一位名下，369 登記在另一位名下。兩筆都是單獨所有、沒有其他共有人，產權其實很單純，<b>但要賣就必須兩位同時簽委託、同時簽約</b>。任何一方中途改變心意，整件事就得重來。買方查謄本一定會看到這件事，我們會主動說明，不會等對方發現。</p>
</div>

<div class="mark w">
<p><b>二、門前那條巷子是別人的土地，您沒有持分。</b></p>
<p>福利路 117 巷的路身是自治段 375 地號，有六位共有人，經過比對，<b>三筆土地的所有權人都不在其中</b>。</p>
<p>這件事聽起來嚴重，但實際影響沒有那麼大。那條巷子已經開闢四十多年，兩側房屋全部是合法建築、都領有門牌 —— 這代表這條巷子過去一定被指定過建築線，否則那些房子蓋不起來。依臺中市的規定，這種情形認定為「現有巷道」<b>不需要那六位共有人同意</b>。</p>
<p>不過這件事必須拿到白紙黑字才算數。<b>我們建議在正式開價前，先向市府申請指定建築線</b>，規費只要 500 元。這張紙一方面確認能不能蓋、要不要退縮，一方面也能直接拿給買方看，省掉很多解釋。</p>
</div>

<h2>稅金與您實際拿到的錢</h2>

<p>三筆土地民國 68 年取得，持有將近 47 年，依法可以減徵 40%。土地增值稅合計約 <b>153 萬</b>，大約是成交總價的 4.5%，以持有這麼久的土地來說算輕的。這個數字我們用財政部官方網站的試算工具核對過，與謄本估算完全相同。</p>
...
<p><b>第一，先辦建築線。</b>500 元、幾個星期，換一張能直接給買方看的證明。這是整件事裡最划算的一筆支出，也會決定開價要落在區間的上緣還是下緣。</p>

<p><b>第二，把地整理乾淨。</b>現在圍籬裡雜草和幾棵樹長得比較高，地面還有些舊磚瓦。花三到五萬清一清，買方到現場看到的是一塊方整的素地，跟看到荒地的出價會差很多，遠超過整理的成本。</p>

<p><b>第三，以 3,950 萬開價。</b>這塊地最值錢的地方，是<b>面寬 34 公尺整排臨路、深度 11.9 公尺</b>，可以直接切成四戶透天，每戶都有自己的出入口，不用留內部通道，土地一坪都不浪費。同樣 123 坪的地，如果是窄長型，只能蓋兩戶還得挪出走道。這是我們對外主推的重點。</p>
...
<div class="links">
<a href="./owner.html">重點摘要版<span>大字・一頁看完</span></a>
