...
<h2>一、標的概要</h2>
<div class="kpis">
<div class="kpi"><div class="lb">建地面積<span class="note"> ・另有巷道持分</span></div><div class="v">123.5<span class="u"> 坪</span></div></div>
...
<div class="callout warn"><b>※ 本節所有單價均指「建地部分」（123.50 坪）。</b>
巷道持分（自治段 375）<b>不適用此單價</b>，應依第四章分段計價（建地單價之 20–30%），
最終總價＝建地部分 ＋ 巷道持分部分。<b>對外行銷呈現總坪數，議價時分開討論兩段價格。</b></div>
...
<ul>
<li>開價 <b>3,950 萬</b>（建地 123.50 坪 × 32 萬），議價空間預留 18 – 20%；
<b>巷道持分另依 20–30% 計價後加計</b></li>
<li><b>報價與議價的兩段式操作：</b>
① <b>文宣寫總坪數</b>「土地總面積 ○○○ 坪（含建地 123.50 坪、巷道持分 ○○ 坪）」，並以<b>總價</b>對外報價；
② <b>議價時分開談</b>——建地部分守 25 萬/坪以上，巷道持分部分本就不值建地價，
可作為最後讓步的籌碼（例如「巷道持分不另計價送給你」），<b>用低成本項目換取建地單價不破底</b></li>
...
<span>張現傑</span>
<span>製表日期：2026.09.22（第 9 版・計價架構定稿）</span>
</div></footer>
</body></html>"""
