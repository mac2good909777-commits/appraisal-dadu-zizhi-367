...
<p style="margin:0 0 18px;display:flex;gap:10px;flex-wrap:wrap"><a href="./explain.html" style="display:inline-block;background:#F5F3EE;border:1px solid #C0A434;border-radius:4px;padding:9px 16px;color:#2B5937;text-decoration:none;font-size:14.5px;font-weight:600">✉ 給地主的說明版 →</a></p>
<h2>一、標的概要</h2>
<div class="kpis">
...
<p>承上，本案循第 1、2、4 款認定為現有巷道的機會高，均無須共有人同意書。但認定為現有巷道之後，<b>還有一道退讓規定必須檢視</b>。</p>
...
<div class="callout warn"><b>⚠ 請留意「屋主實拿」欄位的計算範圍。</b>該欄位<b>僅扣除土地增值稅 152.9 萬</b>，<b>尚未扣除仲介服務費、代書費、印花稅及其他交易相關費用</b>。與屋主溝通淨得金額時務必一併說明，避免事後認知落差。</div>
<div class="callout"><b>稅額構成說明。</b>持有近 47 年，公告現值自民國 68 年的 2,100 元/㎡ 調整至 115 年的 20,600 元/㎡（約 9.8 倍），
...
<span>張現傑</span>
<span>製表日期：2026.09.22（第 16 版）</span>
</div></footer>
</body></html>"""
